...
public class XiaoJinYingMingXiresult2 implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public XiaoJinYingMingXiresult2(String errorCode, String errorMsg,
			String psBillDt, String psDueDt, String cashNum, String odAmt,
			String curPsInstmAmt, String curBillAmt, String lastBillAmt,
			String curAddAmt, String allOdInt, String curNormInt,
			String minAmt, String setlAmt, String curCashAmt, String curFeeAmt) {
		super();
	...
	public XiaoJinYingMingXiresult2() {
		super();
	}
