...
public class XiaoJinYingZhangDanMingXiListAdapter extends BaseAdapter
{
    ...
    public XiaoJinYingZhangDanMingXiListAdapter(List<XiaoJinYingZhangDanXiangQing2> listItems, Context context)
    {
