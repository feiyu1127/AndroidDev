...
public class XIaoaddressHuoQuResponse implements Serializable {

	protected Integer code;
	protected String msg;
	protected String flag;

	public XIaoaddressHuoQuResponseRes getResult() {
		return result;
	}

	public void setResult(XIaoaddressHuoQuResponseRes result) {
		this.result = result;
	}

	protected XIaoaddressHuoQuResponseRes result;
...
// class XIaoaddressHuoQuResponseRes implements Serializable {
//
...
//}
//
//class XiaogetAddressBody implements Serializable {
