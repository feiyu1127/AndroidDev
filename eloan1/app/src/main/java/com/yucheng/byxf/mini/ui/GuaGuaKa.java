...
public class GuaGuaKa extends View
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		mCanvas.drawBitmap(BitmapFactory.decodeResource(getResources(),
				R.drawable.guaguashangceng), null, new RectF(0, 0, width, height), null);
	}
	...
	private Runnable mRunnable = new Runnable()
	{
		...
		public void run()
		{
			...
			if (wipeArea > 0 && totalArea > 0)
			{
				...
				if (percent > 35)
				{
					Log.e("TAG", "清除区域达到35%，下面自动清除");
					isComplete = true;
					postInvalidate();
					//去更新主界面
					mOnFinishView.onActionFinish();
				}
			}
		}
    ...
    private OnFinishView mOnFinishView;

    public void setmOnFinishView(OnFinishView mOnFinishView) {
        this.mOnFinishView = mOnFinishView;
    }
