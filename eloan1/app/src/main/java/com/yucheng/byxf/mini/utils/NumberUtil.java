...
/**
 * 类名: NumberUtil</br> 描述: java 双精度计算工具类</br> 开发人员： weiyb</br> 创建时间： 2015-7-10
 */
...
public class NumberUtil {
	...
	public static double mul(double v1, double v2, double v3) {// 乘法
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
		BigDecimal b2 = new BigDecimal(Double.toString(mul(v2, v3)));
		return b1.multiply(b2).doubleValue();
	}

	public static double mul(double v1, double v2, double v3, double v4) {// 乘法
		BigDecimal b1 = new BigDecimal(Double.toString(v1));
	...
	public static double round(double v) {// 截取5位
		BigDecimal b = new BigDecimal(Double.toString(v));
		BigDecimal one = new BigDecimal("1");
		return b.divide(one, 5, BigDecimal.ROUND_HALF_UP).doubleValue();
	}

	public static double round(double v, int length) {
